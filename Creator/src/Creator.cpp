...
Player Creator::select_player(std::string Id_Player)
{
    std::string sql_query = "SELECT * FROM Player WHERE id_player = " + Id_Player;
...
Server Creator::select_server(std::string id)
{
    std::string sql_query = "SELECT * FROM Server WHERE id_server = " + id;
...
void Creator::delete_player(int id)
{
    std::string sql_query;
...
void Creator::delete_server(int id)
{
    std::string sql_query;
