...
{
	public :
		Server(std::string id,std::string ip,std::string nom,int nombre_joueurs_max,int nombre_joueurs_connectes,bool passwd,std::string carte_jouee,std::string type_partie,float temps_jeu);
	...
	private :
        ...
        void serialize(Archive& ar, const unsigned int version){
            ar & m_id & m_ip & m_nom & m_nombre_joueurs_max & m_nombre_joueurs_connectes & m_passwd & m_carte_jouee & m_type_partie & m_temps_jeu;
        }
