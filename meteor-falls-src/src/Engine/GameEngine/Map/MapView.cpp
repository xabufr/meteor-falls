...
boost::optional<Vector3D> MapView::getIntersection(Ogre::Ray &ray) const
{
    Ogre::TerrainGroup::RayResult localRayIntersects = m_terrainGroup->rayIntersects(ray);
    if(localRayIntersects.hit) {
