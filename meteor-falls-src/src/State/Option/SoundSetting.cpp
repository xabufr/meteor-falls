...
m_state_manager(mgr)
{
    ...
    m_activate = (CEGUI::ToggleButton*)m_window_manager.createWindow("TaharezLook/Checkbox", "CheckBoxActivate");
    m_activate->setSize(CEGUI::USize(CEGUI::UDim(0.50, 0), CEGUI::UDim(0.05, 0)));
    ...
    m_activate->subscribeEvent(CEGUI::ToggleButton::EventSelectStateChanged, CEGUI::Event::Subscriber(&SoundSetting::m_checkbox_used, this));
    CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->getChild("OptionState")->addChild(m_activate);

    m_text_music = (CEGUI::Titlebar*)m_window_manager.createWindow("TaharezLook/StaticText", "TextVolMusic");
    m_text_music->setSize(CEGUI::USize(CEGUI::UDim(0.50, 0), CEGUI::UDim(0.05, 0)));
    ...
    CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->getChild("OptionState")->addChild(m_text_music);

    m_music_volume = (CEGUI::Slider*)m_window_manager.createWindow("TaharezLook/Slider", "SliderVolMusic");
    m_music_volume->setSize(CEGUI::USize(CEGUI::UDim(0.50, 0), CEGUI::UDim(0.05, 0)));
    ...
    CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->getChild("OptionState")->addChild(m_music_volume);

    m_text_ambiant = (CEGUI::Titlebar*)m_window_manager.createWindow("TaharezLook/StaticText", "TextVolAmbiant");
    m_text_ambiant->setSize(CEGUI::USize(CEGUI::UDim(0.50, 0), CEGUI::UDim(0.05, 0)));
    ...
    CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->getChild("OptionState")->addChild(m_text_ambiant);

    m_ambiant_volume = (CEGUI::Slider*)m_window_manager.createWindow("TaharezLook/Slider", "SliderVolAmbiant");
    m_ambiant_volume->setSize(CEGUI::USize(CEGUI::UDim(0.50, 0), CEGUI::UDim(0.05, 0)));
    ...
    CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->getChild("OptionState")->addChild(m_ambiant_volume);

    m_text_effect = (CEGUI::Titlebar*)m_window_manager.createWindow("TaharezLook/StaticText", "TextVolEffect");
    m_text_effect->setSize(CEGUI::USize(CEGUI::UDim(0.50, 0), CEGUI::UDim(0.05, 0)));
    ...
    CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->getChild("OptionState")->addChild(m_text_effect);

    m_effect_volume = (CEGUI::Slider*)m_window_manager.createWindow("TaharezLook/Slider", "SliderVolEffect");
    m_effect_volume->setSize(CEGUI::USize(CEGUI::UDim(0.50, 0), CEGUI::UDim(0.05, 0)));
    ...
    CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->getChild("OptionState")->addChild(m_effect_volume);

    m_text_interface = (CEGUI::Titlebar*)m_window_manager.createWindow("TaharezLook/StaticText", "TextVolInterface");
    m_text_interface->setSize(CEGUI::USize(CEGUI::UDim(0.50, 0), CEGUI::UDim(0.05, 0)));
    ...
    CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->getChild("OptionState")->addChild(m_text_interface);

    m_interface_volume = (CEGUI::Slider*)m_window_manager.createWindow("TaharezLook/Slider", "SliderVolInterface");
    m_interface_volume->setSize(CEGUI::USize(CEGUI::UDim(0.50, 0), CEGUI::UDim(0.05, 0)));
    ...
    CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->getChild("OptionState")->addChild(m_interface_volume);

    m_cancel = (CEGUI::PushButton*)m_window_manager.createWindow("TaharezLook/Button", "ButtonCancel");
    m_cancel->setSize(CEGUI::USize(CEGUI::UDim(0.20, 0), CEGUI::UDim(0.15, 0)));
    ...
    m_accept = (CEGUI::PushButton*)m_window_manager.createWindow("TaharezLook/Button", "ButtonOk");
    m_accept->setSize(CEGUI::USize(CEGUI::UDim(0.20, 0), CEGUI::UDim(0.15, 0)));
    m_accept->setPosition(CEGUI::UVector2(CEGUI::UDim(0.85-(m_accept->getSize().d_height.d_scale+m_cancel->getSize().d_width.d_scale), 0),
                                         CEGUI::UDim(0.95-m_accept->getSize().d_width.d_scale
                                                        , 0)));
    m_accept->setText("Ok");
...
{
    CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->removeChild(m_activate);
    CEGUI::WindowManager::getSingleton().destroyWindow(m_activate);
    CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->removeChild(m_music_volume);
    CEGUI::WindowManager::getSingleton().destroyWindow(m_music_volume);
    CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->removeChild(m_ambiant_volume);
    CEGUI::WindowManager::getSingleton().destroyWindow(m_ambiant_volume);
    CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->removeChild(m_effect_volume);
    CEGUI::WindowManager::getSingleton().destroyWindow(m_effect_volume);
    CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->removeChild(m_interface_volume);
    CEGUI::WindowManager::getSingleton().destroyWindow(m_interface_volume);

    CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->removeChild(m_text_music);
    CEGUI::WindowManager::getSingleton().destroyWindow(m_text_music);
    CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->removeChild(m_text_ambiant);
    CEGUI::WindowManager::getSingleton().destroyWindow(m_text_ambiant);
    CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->removeChild(m_text_effect);
    CEGUI::WindowManager::getSingleton().destroyWindow(m_text_effect);
    CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->removeChild(m_text_interface);
...
void SoundSetting::enter()
{
    ...
    CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->getChild("OptionState")->setSize(CEGUI::USize(CEGUI::UDim(0.5,0), CEGUI::UDim(0.5, 0)));
    CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->getChild("OptionState")->setPosition(CEGUI::UVector2(CEGUI::UDim(0.50-(CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->getChild("OptionState")->getSize().d_height.d_scale/2), 0),
